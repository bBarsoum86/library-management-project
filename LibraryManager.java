...
public class LibraryManager {
    public static void main(String[] args) {
        ...
        ArrayList<LibraryItem> catalog = new ArrayList<>();  // To store LibraryItems (Books, Magazines, AudioBooks)
        ...
        while (true) {
            ...
            if (choice == 1) {
                ...
                // Create a new Book object and add to catalog
                ...
                // Create a new Magazine object and add to catalog
                ...
                // Create a new AudioBook object and add to catalog
